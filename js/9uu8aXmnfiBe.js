          ...
          return (
            ...
            (t.prototype.onFormFail = function (t) {
              ...
              if (
                ...
                e.append("<li>Something went wrng, please try again.</li>");
              this.alert.html(e);
            }),
...
/**
 * Form Utilities
 * These functions provide common form validation and submission helpers
 */

// Global form utility namespace
const FormUtils = {
  /**
   ...
   * @return {boolean} True if the phone format appears valid
   */
  ...
  /**
   * Creates a smooth scrolling effect to an element
  ...
  /**
   * Helper to handle Formspree form submissions
   * @param {HTMLFormElement} form - The form to submit
   * @param {Function} onSuccess - Success callback
   * @param {Function} onError - Error callback
   */
  submitFormspree: function (form, onSuccess, onError) {
    if (!form) return;
